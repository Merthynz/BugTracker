...
namespace BugTracker.Data
{
    public static class DataUtility
    {
        ...
        public static string GetConnectionString(IConfiguration configuration)
        {
            ...
            var databaseUrl = Environment.GetEnvironmentVariable("DATABASE _URL");
            ...
            try
            {
                IList<Project> projects = new List<Project>() {
                    ...
                    new Project()
                    {
                        ...
                        Description="A custom designed .Net Core application with postgres database. The application is a multi tennent application designed to track issue ticket's progress. Implemented with identity and user roles. Tickets are maintained in projects which are maintained by users in therole of project manager. Each project has a team and team members.",
                        StartDate = new DateTime(2021,8,20),
                    ...
                    new Project()
                    {
                        ...
                        Description="A custom designed .Net Core application with postgres database. This is an application to serve as a rolodex of contracts for a given user.",
                        StartDate = new DateTime(2021,8,20),
        ...
        public static async Task SeedDefaultUsersAsync(UserManager<BTUser> userManager)
        {
            ...
            {
                Console.WriteLine("**********  ERROR  **********");
                Console.WriteLine("Error Seeding Default Admin User2.");
                Console.WriteLine(ex.Message);
                Console.WriteLine("******************************");
                throw;
            }
            ...
            {
                Console.WriteLine("**********  ERROR  **********");
                Console.WriteLine("Error Seeding Default Developer6 User.");
                Console.WriteLine(ex.Message);
                Console.WriteLine("******************************");
                throw;
            }
        ...
        public static async Task SeedDemoUsersAsync(UserManager<BTUser> userManager)
        {
            ...
            {
                Console.WriteLine("**********  ERROR  **********");
                Console.WriteLine("Error Seeding Default Demo Admin User.");
                Console.WriteLine(ex.Message);
                Console.WriteLine("******************************");
                throw;
            }
        ...
        {
            // Get project Ids
            int portfolioId = context.Projects.FirstOrDefault(p => p.Name == "Build a supplemental Blog Web Application").Id;
            ...
            try
            {
                IList<Ticket> tickets = new List<Ticket>()
                {
                    ...
                    new Ticket() {Title = "Movie Ticket 17", Description = "Ticket details for movie ticket 17", Created = DateTimeOffset.Now, ProjectId = movieId, TicketPriorityId = priorityLow, TicketStatusId = statusDev, TicketTypeId = typeNewDev },
